        ...
        <div className="m-5 p-4   w-2/3   shadow-2xl rounded">
          <div className=" flex flex-col w-full  ">
            ...
            <p className="mt-4 ">
              ...
              shopping needs. We’re dedicated to giving you the best online
            ...
            <p className="mt-2">
              ...
              we set out to create a platform that’s not just about buying and
            ...
            <li>Wide Selection: We offer a diverse range of products from trusted brands, ensuring that you find exactly what you're looking for.</li>
            ...
            <div className="gap-4 mt-2">
                <p>We’re more than just a shopping site; we’re a community. Follow us on social media to stay updated on our latest offerings, exclusive deals, and to be a part of the NextBuy experience.</p>
                <p>Thank you for choosing NextBuy. We look forward to serving you!</p>
            </div>
            <h1 className="text-3xl mt-8 font-bold">Contact Us</h1>
            <div className="mt-2">
                <p>Have questions or feedback? We're here to help! Reach out to us at:</p>
